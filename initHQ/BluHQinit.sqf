...
//<author='Pterolatypus'>
//set the hq as a medical and repair facility for ACE
_hq setVariable ["ace_medical_isMedicalFacility", true];
_hq setVariable ["ACE_isRepairFacility", true];
//</author>
...
if (!zones_manually_placed) then {
    ...
    if (!zones_created && !manually_chosen) then {
        ...
        _zones_create = [50, 0.2] execVM "initZones\urbanZones.sqf";
    } else {
